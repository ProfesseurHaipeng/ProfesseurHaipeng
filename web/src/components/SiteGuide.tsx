...
const UI_TEXT = {
  zh: {
    ...
    escalating: "正在为您接通高级顾问 Linda…",
    reconnecting: "正在重新连接高级顾问…",
    online: "产品顾问 · 在线",
    onlineHermes: "高级顾问 Linda · 在线",
    takenOver: "项目人员跟进中",
    connectingLog: "正在接入",
